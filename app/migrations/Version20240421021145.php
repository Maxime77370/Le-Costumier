 ...
 */
final class Version20240421021145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, name VARCHAR(32) NOT NULL, color VARCHAR(7) NOT NULL, PRIMARY KEY(id))');
