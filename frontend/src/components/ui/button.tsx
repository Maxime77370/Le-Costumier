  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outlineAnimated:
          "relative border border-primary before:absolute before:inset-y-0 before:left-0 before:w-0 before:bg-primary before:transition-width before:duration-700 before:content-[''] hover:text-background before:hover:w-full [&>*]:z-10",
        none: ''
      },
      size: {
